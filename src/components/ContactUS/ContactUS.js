...
import img7 from "../../images/ContactUS/Ambulance-Contact-Us.jpg";
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  <span className="fw-bold"> Ops@MediAmbulance.com</span>
                  <br />
                  Provider Relations:
                  <span className="fw-bold"> Providers@MediAmbulance.com</span>
                  <br />
                  General Information:
                  <span className="fw-bold"> Info@MediAmbulance.com</span>
                  <br />
                </Card.Text>
                <Card.Text>
                  <span className="fw-bold">
